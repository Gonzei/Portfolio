...
class Tile {
    ...
    public void cascade() {
        ...
        for (Tile t : this.neighbors) {
            if ((t.numOfNeighbors() == 0) && (t.status == 0) && (!t.mine)) {
                t.discoverIt();
                t.cascade();
            } else if ((t.numOfNeighbors() != 0) && (t.status == 0) && (!t.mine)) {
                t.discoverIt();
            }
        }
    }
...
class ExamplesGame {
    ...
    boolean testNumOfNeighbors1(Tester t)
    {
        ...
        t0.neighbors.add(t2);
        t0.neighbors.add(t3);
        return t.checkExpect(t0.numOfNeighbors(), 1);
    }
    ...
    boolean testNumOfNeighbors2(Tester t)
    {
        ...
        t0.neighbors.add(t2);
        t0.neighbors.add(t3);
        return t.checkExpect(t0.numOfNeighbors(), 3);
    }
